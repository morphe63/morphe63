    ...
    if (message.member.permissions.has(['ADMINISTRATOR'] || [])) {
        ...
        if (!arg[1]){
            ...
            if(!arg[2]){
                ...
                db.query(`UPDATE ticket SET category_Direction = '${arg[2]}' WHERE guildId = ${message.guild.id}`)
            }
            ...
            if(!arg[2]){
                ...
                db.query(`UPDATE ticket SET category_Professeur = '${arg[2]}' WHERE guildId = ${message.guild.id}`)
            }
